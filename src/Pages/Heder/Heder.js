...
const Heder = () => {
    return (
        <div data-aos="fade-right" data-aos-duration="200" className='container' style={{ paddingTop: '100px' }} id='home'>
            ...
            <div className="row align-items-center text-start">
                <div className="col-lg-6 col-md-12 p-5 mySelf">
                    ...
                    <Link to={{ pathname: "https://drive.google.com/file/d/1IIJtMRF_ttF0XMxXLpBsHkqzb_j2fh-o/view?usp=sharing" }} target="_blank" ><Button>My Resume</Button></Link>
                </div>
